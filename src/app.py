...
activities = {
    ...
    "Track and Field": {
        "description": "Sprint, distance, jumping and throwing training",
    ...
    "School Orchestra": {
        "description": "Instrumental rehearsals and performances",
...
def unregister_from_activity(activity_name: str, email: str):
    ...
    Query params:
      - email: student's email to remove from the participants list
    """
    # Validate activity exists
    if activity_name not in activities:
        raise HTTPException(status_code=404, detail="Activity not found")
    ...
    # Validate student is actually signed up for this activity
